    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('students') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('students') }}"><i class="far fa-user"></i>
                    <span>Students</span></a>
            </li>
            <li class="{{ Request::is('students/create') ? 'active' : '' }}">
                <a class="nav-link" href="{{ url('students/create') }}"><i class="fa fa-plus"></i> <span>Create
                        Students</span></a>
            </li>
